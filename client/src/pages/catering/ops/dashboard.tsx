    ...
    <Tabs value={activeTab} onValueChange={setActiveTab}>
      ...
      <TabsContent value="quick-actions">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 mb-6">
          ...
          <QuickActionCard icon={FileSpreadsheet} title="Invoice Builder" description="Generate UNIDO Contract Invoice & auto-archive to vault" color="#10b981" onClick={() => setActiveTab("invoice-builder")} />
          <QuickActionCard icon={FileCheck} title="Document & Invoice Vault" description="Archived UNIDO invoices & payment settlement tracker" color="#0284c7" onClick={() => setActiveTab("invoices-vault")} />
