...
// -----------------------------------------------------------------------------
// GLOBAL PORT DATABASE (Country & UN/LOCODE / IATA Searchable Roster)
// -----------------------------------------------------------------------------
...
function PortAutocompleteInput({ 
  ...
  // Filter ports matching search query (Country, City, Name, UN/LOCODE)
...
print("Port autocomplete feature applied successfully to cargo.tsx!")
