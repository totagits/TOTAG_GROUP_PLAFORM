...
export default function CargoPage() {
  ...
  // 4. PUBLIC C&F CLEARING INTEREST & CONTRACT INTAKE FORM STATE (WITH COMPLETE CONTACT FIELDS)
      ...
      <main className="pb-20">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 mt-6">
          <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-8">
            ...
            {/* =================================================================== */}
            {/* TAB 3: B2B CUSTOMER PORTAL (WITH ACCOUNT PROFILE & PASSWORD CHANGE) */}
            {/* =================================================================== */}
            <TabsContent value="b2b-portal" className="space-y-8">
              
              {/* CUSTOMER ACCOUNT AUTHENTICATION PROFILE BAR (IN CUSTOMER ACCOUNT ONLY) */}
                ...
                <Card className="lg:col-span-7 bg-white/80 dark:bg-slate-900/80 border border-slate-200 dark:border-white/10 rounded-3xl p-6 text-slate-900 dark:text-white space-y-6 backdrop-blur-xl shadow-xl">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <Input defaultValue={customerAccount.companyName} className="bg-slate-50 dark:bg-slate-950 border-slate-300 dark:border-white/10 text-slate-900 dark:text-white rounded-xl text-xs mt-1" />
                    </div>
                    <div>
        ...
        {/* MODAL 1: AUTOMATED ONBOARDING / CONTRACT EMAIL INBOX PREVIEW */}
        <AnimatePresence>
                ...
                <div className="bg-slate-50 dark:bg-slate-950 p-5 rounded-2xl border border-slate-200 dark:border-white/10 space-y-4 text-xs">
                  ...
                  {onboardingEmail.type === "NEW_CUSTOMER_ONBOARDING" ? (
                    <div className="space-y-3 leading-relaxed text-slate-700 dark:text-slate-300">
                      ...
                      <p className="text-[11px] text-slate-500 dark:text-slate-400">For security compliance, please log in to your customer account in the B2B Portal and update your password.</p>
                    </div>
                  ) : (
                    <div className="space-y-3 leading-relaxed text-slate-700 dark:text-slate-300">
                      <p>Dear <strong>{onboardingEmail.signatory}</strong> ({onboardingEmail.companyName}),</p>
        ...
        {/* MODAL 2: INTERACTIVE PASSWORD CHANGE MODAL (ACCESSIBLE IN CUSTOMER PORTAL) */}
        <AnimatePresence>
          {isPasswordModalOpen && (
            <motion.div 
              initial={{ opacity: 0 }}
...
print("Applied public contract contact fields, automated dual onboarding logic, and moved Change Password to B2B Customer Portal successfully!")
