...
export default function CargoPage() {
  ...
  // 1. CUSTOMER ACCOUNT AUTHENTICATION STATE (Managed inside B2B Portal)
  ...
  // 2. AUTOMATED ONBOARDING EMAIL & TEMPORARY CREDENTIALS STATE
  ...
  // 3. B2B CARGO BOOKING ENGINE & PRINTABLE AWB DOCUMENT STATE
  ...
  // 4. MANDATORY DOCUMENT ATTACHMENT VAULT STATE
  ...
  // 5. PUBLIC C&F CLEARING INTEREST & CONTRACT INTAKE FORM STATE
  ...
  // 6. PUBLIC DISCOVERY & RATE CALCULATOR STATE
  ...
  // 8. C&F AGENT & CUSTOMS BROKERAGE INTERACTIVE STATE
  ...
  // 9. WMS & RAMP SCANNER SIMULATOR STATE
  ...
  // 10. ULD BUILD-UP WEIGHT SAFETY ENGINE STATE
  ...
  // 11. DISCREPANCY & CLAIMS REPORT STATE WITH PHOTO DROPZONE
      ...
      <main className="pb-20">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 mt-6">
          <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-8">
            ...
            {/* =================================================================== */}
            {/* TAB 3: B2B CUSTOMER PORTAL (CLEANED UP ACCOUNT HEADER)              */}
            {/* =================================================================== */}
            <TabsContent value="b2b-portal" className="space-y-8">
              
              {/* CLEAN ENTERPRISE CUSTOMER ACCOUNT PROFILE HEADER BAR */}
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <div className="flex items-center space-x-2">
                      ...
                      {customerAccount.isPasswordChanged ? (
                        <Badge className="bg-emerald-500/20 text-emerald-600 dark:text-emerald-400 border border-emerald-500/30 font-bold text-[10px] flex items-center space-x-1">
                          <Check className="w-3 h-3 text-emerald-500" />
                          <span>Password Secured</span>
                        </Badge>
                      ) : (
                        <Badge className="bg-amber-500/20 text-amber-600 dark:text-amber-400 border border-amber-500/30 text-[10px]">
                          Temp Password Active
                        </Badge>
                      )}
                    </div>
                    <p className="text-xs text-slate-500 dark:text-slate-400 font-mono mt-0.5">
                      TIN: {customerAccount.tinNumber} • Email: {customerAccount.email} • Phone: {customerAccount.phone}
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-2.5">
                  {onboardingEmail && (
                    <Button 
                      ...
                      className="bg-sky-500/10 border border-sky-500/30 text-sky-600 dark:text-sky-400 hover:bg-sky-500/20 text-xs font-bold rounded-xl px-4 py-2"
                    >
                      <Mail className="w-3.5 h-3.5 mr-1.5" />
                      <span>View Email Receipts</span>
                    </Button>
                  )}

                  <Button 
                    onClick={() => setIsSettingsModalOpen(true)}
                    className="bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-900 dark:text-white border border-slate-300 dark:border-white/10 text-xs font-bold rounded-xl px-4 py-2 transition-all flex items-center space-x-1.5"
                  >
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                ...
                {/* Automated Shipment Booking Engine & Printable AWB Generator */}
                <Card className="lg:col-span-7 bg-white/80 dark:bg-slate-900/80 border border-slate-200 dark:border-white/10 rounded-3xl p-6 text-slate-900 dark:text-white space-y-6 backdrop-blur-xl shadow-xl">
                  <div className="flex items-center justify-between border-b border-slate-200 dark:border-white/10 pb-4">
                    <div>
        ...
        {/* MODAL 1: OFFICIAL TOTAG ENTERPRISE AIR WAYBILL (AWB) PRINTABLE DOCUMENT CERTIFICATE */}
        <AnimatePresence>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-xs">
                  ...
                  <div className="bg-slate-50 dark:bg-slate-950/60 p-4 rounded-2xl border border-slate-200 dark:border-white/10 space-y-2">
                    ...
                    <div className="space-y-1 text-slate-800 dark:text-slate-200">
                      ...
                      <p className="text-[11px] text-slate-500 dark:text-slate-400">Account Ref: TOTAG-ACC-99201</p>
                    </div>
                  </div>
                  ...
                  <div className="bg-slate-50 dark:bg-slate-950/60 p-4 rounded-2xl border border-slate-200 dark:border-white/10 space-y-2">
                    ...
                    <div className="space-y-1 text-slate-800 dark:text-slate-200">
                      ...
                      <p className="text-[11px] text-slate-500 dark:text-slate-400">TIN: LRA-TIN-9940218</p>
                    </div>
                  </div>
        ...
        {/* MODAL 2: AUTOMATED ONBOARDING / CONTRACT EMAIL INBOX PREVIEW */}
        <AnimatePresence>
                ...
                <div className="bg-slate-50 dark:bg-slate-950 p-5 rounded-2xl border border-slate-200 dark:border-white/10 space-y-4 text-xs">
                  ...
                  {onboardingEmail.type === "NEW_CUSTOMER_ONBOARDING" ? (
                    <div className="space-y-3 leading-relaxed text-slate-700 dark:text-slate-300">
                      ...
                      <p className="text-[11px] text-slate-500 dark:text-slate-400">For security compliance, please log in to your customer account in the B2B Portal and update your password in Account Settings.</p>
                    </div>
                  ) : (
                    <div className="space-y-3 leading-relaxed text-slate-700 dark:text-slate-300">
                      <p>Dear <strong>{onboardingEmail.signatory}</strong> ({onboardingEmail.companyName}),</p>
                ...
                <div className="flex justify-end space-x-3">
                  {onboardingEmail.type === "NEW_CUSTOMER_ONBOARDING" && (
                    ...
                    >
                      ...
                      <span>Log In & Change Password Now</span>
                    </Button>
                  )}
        ...
        {/* MODAL 3: ENTERPRISE ACCOUNT SETTINGS & SECURITY MODAL */}
        <AnimatePresence>
          {isSettingsModalOpen && (
            <motion.div 
              initial={{ opacity: 0 }}
            ...
            >
              ...
              >
                ...
                <div className="flex items-center space-x-3 border-b border-slate-200 dark:border-white/10 pb-4">
                  ...
                  <div>
                    <h3 className="text-lg font-bold text-slate-900 dark:text-white">Account Settings & Security Portal</h3>
                    <p className="text-xs text-slate-500 dark:text-slate-400">Manage credentials & security preferences for {customerAccount.companyName}</p>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  <div className="bg-slate-100 dark:bg-slate-950 p-4 rounded-2xl border border-slate-200 dark:border-white/10 space-y-2 text-xs">
                    <div className="flex justify-between items-center text-slate-600 dark:text-slate-400">
                      ...
                      <span className="font-bold text-slate-900 dark:text-white">{customerAccount.accountType}</span>
                    </div>
                    <div className="flex justify-between items-center text-slate-600 dark:text-slate-400">
                      <span>Email Address:</span>
                      <span className="font-bold text-slate-900 dark:text-white">{customerAccount.email}</span>
                    </div>
                    <div className="flex justify-between items-center text-slate-600 dark:text-slate-400">
                      <span>LRA Tax ID (TIN):</span>
                      <span className="font-mono font-bold text-emerald-600 dark:text-emerald-400">{customerAccount.tinNumber}</span>
                    </div>
                  </div>

                  <div className="p-4 bg-emerald-500/10 border border-emerald-500/30 rounded-2xl flex items-center justify-between">
                    <div>
                      <span className="font-bold text-slate-900 dark:text-white text-xs block">Account Access Credentials</span>
                      <span className="text-[10px] text-slate-500 dark:text-slate-400 block">
                        {customerAccount.isPasswordChanged ? "Permanent password active" : "Using temporary password from onboarding email"}
                      </span>
                    </div>
                    <Button 
                      onClick={() => {
                      ...
                      className="bg-emerald-500 hover:bg-emerald-400 text-slate-950 text-xs font-black rounded-xl px-4 py-2 shadow-lg"
                    >
        ...
        {/* MODAL 4: INTERACTIVE PASSWORD CHANGE MODAL */}
        <AnimatePresence>
          {isPasswordModalOpen && (
            <motion.div 
              initial={{ opacity: 0 }}
            ...
            >
              ...
              >
                ...
                <div className="flex items-center space-x-3 border-b border-slate-200 dark:border-white/10 pb-4">
                  ...
                  <div>
                    <h3 className="text-lg font-bold text-slate-900 dark:text-white">Customer Account Password Change</h3>
                    <p className="text-xs text-slate-500 dark:text-slate-400">Set a new permanent password for {customerAccount.email}</p>
                  </div>
                </div>

                <form onSubmit={handlePasswordResetSubmit} className="space-y-4">
                  <div>
                    <Label className="text-xs text-slate-600 dark:text-slate-300 font-bold">Temporary / Current Password</Label>
                    <Input 
                      value={passwordForm.tempPasswordInput} 
                      onChange={(e) => setPasswordForm({...passwordForm, tempPasswordInput: e.target.value})}
                      placeholder="Enter temporary password received in email..."
                      className="bg-slate-50 dark:bg-slate-950 border-slate-300 dark:border-white/10 text-slate-900 dark:text-white rounded-xl text-xs mt-1 font-mono"
                    />
                  </div>
...
print("Applied printable AWB document modal and replaced standalone change password button with Account Settings & Security portal button successfully!")
