  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-white font-sans selection:bg-emerald-500 selection:text-slate-950 transition-colors">
      ...
      <main className="pb-20">
              ...
              <div className="bg-gradient-to-r from-slate-900 via-emerald-950 to-slate-900 border border-emerald-500/20 p-6 rounded-3xl text-white shadow-xl flex flex-col md:flex-row items-center justify-between gap-4">
                ...
                <div className="flex items-center space-x-3">
                  <Button 
                    ...
                    className="bg-emerald-500 hover:bg-emerald-400 text-slate-950 text-xs font-black rounded-xl px-4 py-2.5 shadow-lg flex items-center space-x-1.5"
                  >
        ...
        {/* MODAL 3: ORG MULTI-USER RBAC MODAL */}
        <AnimatePresence>
          {isNewUserModalOpen && (
            <motion.div 
              initial={{ opacity: 0 }}
        ...
        {/* MODAL 4: DISPUTE TICKETING & BILLING DISPUTE MODAL */}
        <AnimatePresence>
          {isDisputeModalOpen && (
            <motion.div 
              initial={{ opacity: 0 }}
        ...
        {/* MODAL 5: INTERACTIVE PASSWORD CHANGE MODAL (ACCESSED VIA ONBOARDING EMAIL OR LOGIN) */}
        <AnimatePresence>
          {isPasswordModalOpen && (
            <motion.div 
              initial={{ opacity: 0 }}
...
print("Applied dual-structure self-service lifecycle architecture to cargo.tsx successfully!")
